...
* `git clone git@github.com:rumblex/angularattack2016-moove-it-arg.git`

* `cd angularattack2016-moove-it-arg`
...
If receive the error message `"You do not have permission to publish to moove-it-arg.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add lucas.aragno157@gmail.com`
